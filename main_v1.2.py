...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Badan Riset dan Inovasi Nasional.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def plot(self, LSTM_predict, TFM_predict, true, cycle):
        ...
        try:
            ...
            self.ax.plot(LSTM_predict, label="LSTM")
            self.ax.plot(TFM_predict, label="Transformer")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Remaining Useful Lifetime Plot"))
